...
// --- ব্রাউজার ট্যাব বন্ধ বা রিফ্রেশ করলে অফলাইন করার ক্রুשיয়াল লজিক ---
...
function logout() {
    ...
    // --- [যুক্ত করা হয়েছে] লোকালস্টোরেজ থেকে সেশন ক্লিয়ার ---
...
async function loadUserData() {
    ...
    // রিকভার করা সাবজেক্ট থাকলে সেটিই সিলেক্ট রাখবে
...
function startTimer() {
    ...
    // --- [যুক্ত করা হয়েছে] টাইমার স্টেট সেভ ---
...
function handleTimerTick() {
    ...
    // ব্যাকগ্রাউন্ডের জন্য প্রতি সেকেন্ডে বর্তমান সময় ও রানিং স্টেট সিঙ্ক রাখা
    localStorage.setItem('last_active_timestamp', Date.now().toString());
...
function stopTimer() {
    ...
    // --- [যুক্ত করা হয়েছে] টাইমার স্টেট আপডেট ---
...
document.addEventListener('visibilitychange', () => {
    // অ্যাপ সামনে আসলে এবং আগে টাইমার রানিং থাকলে ব্যাকগ্রাউন্ড টাইম রিকভার করবে
    const wasTimerRunning = localStorage.getItem('was_timer_running') === 'true';
    
    if (document.visibilityState === 'visible' && (isRunning || wasTimerRunning)) {
        ...
        if (elapsedSeconds > 2) { 
            ...
            const wasSubTimerRunning = localStorage.getItem('was_sub_timer_running') === 'true';
            if (isSubjectTimerRunning || wasSubTimerRunning) {
                if(!userSubjectDailyLogs[todayStr]) userSubjectDailyLogs[todayStr] = {};
